...
class ExtinguisherDetailScreen extends StatelessWidget {
  ...
  const ExtinguisherDetailScreen({super.key, required this.extinguisherId});
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                context.push('/extinguishers/edit/$extinguisherId'),
          ),
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildSection('Historial de Inspecciones', [
  ...
  Widget _buildInspectionHistoryItem(
    String date,
    String inspector,
    String notes,
  ) {
